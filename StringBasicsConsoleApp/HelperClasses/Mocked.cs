...
namespace StringBasicsConsoleApp.HelperClasses
{
    public class Mocked
    {
        ...
        public static List<string> RussianMonthNames() =>
            Enumerable.Range(1, 12).Select((index) => new CultureInfo("ru-RU").DateTimeFormat.GetMonthName(index)).ToList();

        public static List<string> VietnameseMonthNames() =>
            Enumerable.Range(1, 12).Select((index) => new CultureInfo("vie").DateTimeFormat.GetMonthName(index)).ToList();

        public static List<string> SpanishMonthNames() =>
            Enumerable.Range(1, 12).Select((index) => new CultureInfo("es").DateTimeFormat.GetMonthName(index)).ToList();
    }
}
